...
shinyServer(function(input, output, session) {
  ...
  switch_percent_change <- function(txt) {
    updateTabsetPanel(session, "percent-change", selected = txt)
  }
  
  observeEvent(input$c_states, switch_percent_change("tab_states"))
  observeEvent(input$c_countries, switch_percent_change("tab_countries"))
